...
.main-color-bg{
	...
	padding:0 ;
	 ...
	 background-color:#34495e !important;     <!--Main theme #595cb6 color-->
...
<body>
	...
	<nav class="main-color-bg navbar-static-top">
		<div class="container">
...
<li><a href="#"><i class="glyphicon glyphicon-list-alt "></i>Stock Management System</a></li></ul>
...
<li id="navDashboard"><a href="index.php"><i class="glyphicon glyphicon-list-alt"></i> Dashboard</a></li>        
        ...
        <li id="navUser"><a href="User.php"> <i class="glyphicon glyphicon-user"></i> User </a></li>     
