		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">Tax 13%</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-success" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Add Row </button>
			      ...
			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-primary"><i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>

			      <button type="reset" class="btn btn-success" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Reset</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
